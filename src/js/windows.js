export default class Window {
  constructor(el, initX, initY) {
    ...
    // console.log(window.innerHeight, rectangle.height)
    this.posX = Math.random() * (window.innerWidth - rectangle.width);
    // console.log(Math.random())
    this.posY = Math.random() * (window.innerHeight/1.5 - rectangle.height);
    // console.log(this.posY)
    this.setWindowPosition();

    el.addEventListener("mousedown", (e) => this.onMouseDown(e));
    el.addEventListener("touchstart", (e) => this.onMouseDown(e));
  }
